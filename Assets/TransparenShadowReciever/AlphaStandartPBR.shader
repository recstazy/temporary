Shader "AlphaStandartPBR"
{
    Properties
    {
        Color0("Color", Color) = (1, 1, 1, 0.2470588)
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float4 _Property_29CCB675_Out_0 = Color0;
                float _Split_5B5E098F_R_1 = _Property_29CCB675_Out_0[0];
                float _Split_5B5E098F_G_2 = _Property_29CCB675_Out_0[1];
                float _Split_5B5E098F_B_3 = _Property_29CCB675_Out_0[2];
                float _Split_5B5E098F_A_4 = _Property_29CCB675_Out_0[3];
                surface.Albedo = (_Property_29CCB675_Out_0.xyz);
                surface.Normal = IN.TangentSpaceNormal;
                surface.Emission = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
                surface.Metallic = 0;
                surface.Smoothness = 0.5;
                surface.Occlusion = 1;
                surface.Alpha = _Split_5B5E098F_A_4;
